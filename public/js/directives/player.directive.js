    ...
    return {
        ...
        link: function(scope, elem, attrs) {
            ...
            scope.prev = function(idx) {
                // console.log('Showing Prev Card', ['Card #' + idx], 'CARD NODE', cards);
                // console.log('PREV/THIS CARD', [cards[idx]]);
                // console.log('NEXT CARD', [cards[idx - 1]]);
            ...
            scope.next = function(idx) {
                // console.log('Showing Next Card', ['Card #' + idx], 'CARD NODE', cards);
                // console.log('PREV/THIS CARD', [cards[idx]]);
                // console.log('NEXT CARD', [cards[idx + 1]]);
