app
  .service('Cards', function($rootScope) {
    ...
    CardList.ActiveCardIdx = 0;
  	...
  	var masterCards = [{"id":2753,"cardType":"Q","text":"Believe it or not, Jim Carrey can do a dead-on impression of _________.","numAnswers":1,"expansion":"90s"},
    {"id":2754,"cardType":"Q","text":"It's Morphin' Time! Mastodon! Pterodactyl! Triceratops! Sabertooth Tiger! _________!","numAnswers":1,"expansion":"90s"},
    {"id":2755,"cardType":"Q","text":"Tonight on SNICK: Are You Afraid of _________?","numAnswers":1,"expansion":"90s"},
    ...
    {"id":2830,"cardType":"Q","text":"And today's soup is Cream of _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2831,"cardType":"Q","text":"Now in bookstores: The Audacity of _________, by Barack Obama.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2832,"cardType":"Q","text":"WHOOO! God damn I love _________!","numAnswers":1,"expansion":"CAHe5"},
    {"id":2833,"cardType":"Q","text":"Do you lack energy? Does it sometimes feel like the whole world is _________? Zoloft.&reg;","numAnswers":1,"expansion":"CAHe5"},
    {"id":2834,"cardType":"Q","text":"Hi, this is Jim from accounting. We noticed a $1,200 charge labeled _________. Can you explain?","numAnswers":1,"expansion":"CAHe5"},
    {"id":2835,"cardType":"Q","text":"Well if _________ is good enough for _________, it's good enough for me.","numAnswers":2,"expansion":"CAHe5"},
    {"id":2836,"cardType":"Q","text":"Yo' mama so fat she _________!","numAnswers":1,"expansion":"CAHe5"},
    {"id":2837,"cardType":"Q","text":"What killed my boner?","numAnswers":1,"expansion":"CAHe5"},
    {"id":2838,"cardType":"Q","text":"Don't forget! Beginning this week, Casual Friday will officially become _________ Friday.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2839,"cardType":"Q","text":"In his farewell address, George Washington famously warned Americans about the dangers of _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2840,"cardType":"Q","text":"Having the worst day EVER. #_________","numAnswers":1,"expansion":"CAHe5"},
    {"id":2841,"cardType":"Q","text":"Get ready for the movie of the summer! One cop plays by the book. The other's only interested in one thing: _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2842,"cardType":"Q","text":"What's making things awkward in the sauna?","numAnswers":1,"expansion":"CAHe5"},
    {"id":2843,"cardType":"Q","text":"Life's pretty tough in the fast lane. That's why I never leave the house without _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2844,"cardType":"Q","text":"Patient presents with _________. Likely a result of _________.","numAnswers":2,"expansion":"CAHe5"},
    {"id":2845,"cardType":"Q","text":"Hi MTV! My name is Kendra, I live in Malibu, I'm into _________, and I love to have a good time.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2846,"cardType":"Q","text":"Help me doctor, I've got _________ in my butt!","numAnswers":1,"expansion":"CAHe5"},
    {"id":2847,"cardType":"Q","text":"Why am I broke?","numAnswers":1,"expansion":"CAHe5"},
    {"id":2848,"cardType":"Q","text":"I don't mean to brag, but they call me the Michael Jordan of _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2849,"cardType":"Q","text":"Heed my voice, mortals! I am the god of _________, and I will not tolerate _________!","numAnswers":2,"expansion":"CAHe5"},
    {"id":2850,"cardType":"Q","text":"Here at the Academy for Gifted Children, we allow students to explore _________ at their own pace.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2851,"cardType":"Q","text":"Well what do you have to say for yourself, Casey? This is the third time you've been sent to the principal's office for _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2852,"cardType":"Q","text":"In his new action comedy, Jackie Chan must fend off ninjas while also dealing with _________.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2853,"cardType":"Q","text":"Armani suit: $1,000. Dinner for two at that swanky restaurant: $300. The look on her face when you surprise her with _________: priceless.","numAnswers":1,"expansion":"CAHe5"},
    {"id":2854,"cardType":"Q","text":"Do the Dew &reg; with our most extreme flavor yet! Get ready for Mountain Dew _________!","numAnswers":1,"expansion":"CAHe5"}];

    var answerCards = masterCards.filter(isAnswerCard),
        questionCards = masterCards.filter(isQuestionCard);
    
    function setActiveCard(idx) {
        console.log(["Setting Active Card To IDX", idx])
        
        CardList.ActiveCardIdx = idx;
    }
    ...
    function getCards(cardData, qty) {
        ...
        for (var i = 0; i < qty; i++) {
            // Get Random Index
            var randomCard = function() { return Math.floor(Math.random() * cardData.length) };
            // Check For Card Already In List
            var checkDup = function (list, card){
                var isInList = list.some(function(c){ return c.id === card.id; });
                // Recursive Check To Return A 
                // Card Not In the List
                if (!isInList) return card;
                else return checkDup(list, cardData[randomCard()]);
            }
            // Select A Card
            var myCard = checkDup( cards.length > 0 ? cards : [{ id: -1 }], cardData[randomCard()] );
            // Add Card To List
            cards.push(myCard);
        }
    ...
    // Function Factory
    CardList.masterCards = masterCards;
    CardList.answerCards = answerCards;
    CardList.questionCards = questionCards;
